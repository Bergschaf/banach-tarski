...
\begin{definition}[Zerlegung in Mengen] \label{def:zerlegung_L_D} \uses{def:menge_rep_punkte,def:vereinigung_x,konk_rot}
...
\end{lemma}
\begin{proof} \uses{def:zerlegung_L_D,konk_rot}
Steht noch aus.
\end{proof}
...
\end{lemma}
\begin{proof}\uses{def:aequidekomponierbar,lem:abz_fixpunkte}
...
\end{theorem}
\begin{proof} \uses{lemma:verdopplung_L_D,lem:aequidekomponierbarkeit,lemma:aequi_kugel}
