...
\lean{adjugate_fin_three} \leanok
\end{lemma}
\begin{proof}
\leanok 
\end{proof}
...
Matrizen einfügen
\end{lemma}
\begin{proof}\uses{def:konk_rot_erzeugt,def:konk_rot,lem:adjugate_fin_three}
sorry
\end{proof}
...
\end{lemma}
\begin{proof} \uses{lem:darst_von_rot_matrix,lem:adjugate_fin_three}
