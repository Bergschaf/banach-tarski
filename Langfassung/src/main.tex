...
\begin{figure*}[ht]
    ...
    \includegraphics[scale=2]{Standfoto_cropped.jpg}
...
Die Forschung in der Mathematik ist eine aktive und sehr lebendige Welt. Weltweit wurden im Fachbereich Mathematik seit 1996 insgesamt 4,5 Millionen Dokumente publiziert. Davon sind rund 300.000 allein im Jahr 2022 entstanden. Das entspricht einem Anstieg von rund 10\% im Vergleich zum Vorjahr \cite{Q1}. All diese Aufsätze und die darin enthaltenen Beweise müssen selbstverständlich auch auf Korrektheit geprüft werden. Das muss jedoch mit großer Sorgfalt geschehen, da ein Beweis, der sich auf eine vorherige falsche Arbeit bezieht, ebenfalls ungültig ist. Aufgrund dieser Schwierigkeiten beschränkt sich die Arbeit an hochkomplexen mathematischen Beweisen oft auf wenige, sehr kleine Arbeitsgruppen. \glqq Man arbeitet nicht mit Leuten zusammen, die man nicht kennt\grqq, sagt Leonardo de Moura, Mitbegründer von Lean. \cite{Q2} \glqq Ist diese Person wirklich ernst zu nehmen? Weiß sie, was sie tut? \grqq. Dieses Misstrauen wird zusätzlich durch die rasant ansteigende Komplexität moderner mathematischer Beweise gefördert - Peter Scholze, Träger einer Fields-Medaille sagte in einem Interview, 
dass seine Arbeit weltweit von nur etwa zehn Menschen komplett verstanden wurde \cite{Q2}. In derartig anspruchsvollen Beweisen kann es natürlich vorkommen, dass Lücken übersehen werden, was fatale Folgen hat. Daher hat Peter Scholze die Lean Community herausgefordert, sein Liquid Tensor Experiment in Lean zu formalisieren \cite{Q3}. Die Lean Community hat sich dieser Aufgabe angenommen und anderthalb Jahre später das Liquid Tensor Experiment vollständig in Lean verifiziert \cite{Q4}. Im Gegensatz zu dem ursprünglichen mathematischen Beweis konnten an der Formalisierung viele Menschen parallel arbeiten, was verdeutlicht, wie Lean die Zusammenarbeit zwischen Mathematikern revolutioniert. Es ist nicht mehr notwendig, jeden Mathematiker persönlich zu kennen, um vertrauenswürdige Ergebnisse zu erreichen - Lean falsifiziert oder verifiziert jeden Beitrag sofort.
...
% TODO zitat in der nächsten zeile überprüfen
\noindent Das Liquid Tensor Experiment ist nur ein Beispiel wie \glqq  Formale Beweisassistenten eine Zusammenarbeit in wirklich großem Ausmaß [ermöglichen]\grqq - Dieses Zitat stammt von dem Mathematiker und Fields-Medallienträger Terence Tao aus seinem Vortrag \glqq Machine assisted proofs\grqq~vom 3. Januar 2024 \cite{Q5}. Auch er hat seine Arbeit in Lean formalisiert und ist damit Teil der stetig wachsenden Lean-Community, die hier intensivst forscht und große Schritte nach vorne macht. Auch wenn wir noch sehr jung sind, wollen wir auch ein Teil dieser Lean-Community werden. 
%Uns haben die Gedanken fasziniert und wir haben uns zum Ziel gesetzt, einen Teil in der Mathlib Bibliothek der maschinell überprüften Beweise beizutragen. %und so an einer ganz kleinen Stelle als Autoren verewigt zu werden.\par
...
\end{figure}
\end{minipage}
\begin{minipage}{0.652\linewidth}
Die aktuellste Version von Lean (Lean4) ermöglicht die Kontrolle von Beweisen in fast allen Teilgebieten der Mathematik auf Basis der sogenannten Typentheorie. Die erste offizielle Version von Lean4 wurde erst im September 2023 veröffentlicht \cite{Q8}, was Lean4 zu einem der aktuellsten Beweisassistenten macht.
\end{minipage}\\

\noindent Bereits in Lean formalisierte mathematische Theoreme werden in einer allgemein zugänglichen Bibliothek, genannt Mathlib Bibliothek, gespeichert. Die Aussagen dieser Sätze können dann ohne einen weiteren Beweis vorausgesetzt werden und bei dem Formalisieren von neuen Sätzen inkl. Beweis verwendet werden. Die Lean Community hat bereits über die Hälfte des Grundstudiums der Mathematik sowie einige sehr fortgeschrittene Konzepte (\cite{Q6}) in Lean digitalisiert \cite{Q7}.

%Aufgrund des jungen Alters von Lean umfasst diese Bibliothek aber noch lange nicht den aktuellen Stand der mathematischen Forschung und es sind viele Lücken vorzufinden. \cite{Q8}\par
...
Auf der Suche nach einem spannenden und alltagsnahen mathematischen Satz, der noch nicht in der sogenannten Mathlib Bibliothek ist, sind wir auf den Satz von Banach-Tarski gestoßen, auch bekannt als Banach-Tarski-Paradoxon. % TODO nicht konsistent mit Präsentation
\vspace*{-0.8cm}
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.15]{Bild Banach Tarski.png}
    \label{Abb2}
    \caption{Anschauliche Darstellung der Hauptaussage von Banach-Tarski \cite{Q23} }
...
\noindent Unser Ziel ist es also, den Satz von Banach-Tarski in Lean zu formalisieren. Diese Formalisierung soll dann auch Teil der Mathlib werden.

% TODO explizites Ziel 

\section{Material und Methoden}

\subsection{Entwicklungsumgebung}
Als Entwicklungsumgebung für Lean wird normalerweise VS Code in Kombination mit dem Lean4 Plugin \cite{Q9} verwendet. Dieses implementiert einen Language Server, der die Lean Programme in Echtzeit kompiliert und auf Fehler überprüft. Außerdem werden in einem Fenster neben dem Programm Informationen, z.B. zu dem aktuellen Theorem angezeigt. Eine ähnliche Ansicht findet sich auf der \href{https://live.lean-lang.org/} Internetseite.
...
% TODO evtl. diese Bilder weg und auf Livelean verlinken
\vspace{-0.2cm}
\hspace{-0.4cm}
\begin{figure}[H]
    \centering
...
Um das schreiben von Lean Programmen einfacher und zugänglicher für Mathematiker zu machen, die keine Erfahrung mit Vscode oder Emacs haben, hat die Lean Community den Lean 4 Webeditor entwickelt \cite{Q10}. Auf der Internetseite \href{https://live.lean-lang.org/}{https://live.lean-lang.org/} können im Browser Lean Programme erstellt werden. Ein wichtiges Feature ist die Lean Infoansicht, die, wie in Vscode auf der rechten Seite des Bildschirms angezeigt wird. Die Informationen, die dort angezeigt werden, werden im Browser genauso wie in Vscode von einem Lean Language Server erzeugt. Dieser kommuniziert über das Language Server Protocol (LSP) mit dem Editor \cite{Q11}. Dabei werden die Änderungen, die der Nutzer im Programm vornimmt über das LSP an den Language Server geschickt. Dieser überprüft dann das Programm und schickt die Informationen über die Beweise an den Editor, der diese in einem Fenster auf der rechten Seite des Programms anzeigt. Die Lean4 Vscode Erweiterung startet einen Language Server lokal auf dem Computer, auf dem auch Vscode ausgeführt wird. Der Language Server für den Lean 4 Webeditor wird aber nicht im Browser, sondern auf einem Webserver ausgeführt. Das hat viele Vorteile, da Lean nicht auf dem Endgerät installiert sein muss, auf dem der Code bearbeitet wird. Das bietet die Möglichkeit einen Webserver einzusetzen, der deutlich Leistungsfähiger ist, als der Computer, der benutzt wird um den Webeditor aufzurufen. Das ist vor allem bei großen Projekten hilfreich, da z.B. ein Laptop, auf dem Vsocde mit der Lean 4 Erweiterung läuft durchaus an seine Leistungsgrenzen kommen kann. 
...
\begin{subfigure}{.4\textwidth}
      \centering
    \includesvg[height=0.75\linewidth]{livelean-org.drawio.svg}
    \caption{Architektur des Lean 4 Webeditors}
    \label{Architektur des Lean 4 Webeditors}
\end{subfigure}%
\begin{subfigure}{.6\textwidth}
      \centering
    \includesvg[height=0.5\linewidth]{livelean.drawio.svg}
    \caption{Architektur von unserer Version des Lean 4 Webeditors}
    \label{Architektur des Lean 4 Webeditors}
\end{subfigure}
\end{figure}
\noindent Um diese Probleme zu lösen haben wir eine eigene, erweiterte Version des Lean 4 Webeditors entwickelt \cite{Q13}. Auf dem Webserver von unserer Version liegt neben dem Lean Language Server eine lokale Kopie von unserem Github Repository. Der Editor im Browser kann damit auf alle Dateien in unserem Repository zugreifen. Die Änderungen an der bearbeiteten Datei, die an den Language Server geschickt werden, werden in unserer Version auch in der lokalen Kopie von unserem Repository gespeichert. Dieses wird dann automatisch mit unserem Github Reposiory synchronisiert. Damit ist es nicht mehr notwendig Vscode, Lean und Git zu installieren, um an unserem Projekt zu arbeiten. 

\subsection{Mathlib Bibliothek}
Eines der großen Ziele von Lean ist es, alle Beweise der Mathematik zu formalisieren und so zu überprüfen. Davon ist die Lean-Community zwar noch weit entfernt, aber es sind bereits viele grundlegende mathematische Theoreme und Lemmata aus vielen verschiedenen Bereichen in Lean implementiert. Zurzeit ist bereits ein signifikanter Teil der Bachelor-Mathematik in Lean implementiert \cite{Q14}. Diese Theoreme, Lemmata und Definitionen sind in der Mathlib \cite{Q15} katalogisiert und können so auch in darauf aufbauenden Beweisen verwendet werden. Die Mathlib wurde ursprünglich in einer älteren Lean3-Version verfasst, ist aber mittlerweile vollständing in Lean4 übersetzt. Außerdem ist sie frei zugänglich, d.h. jeder kann sie in eigenen Lean Projekten verwenden und auch Erweiterungsvorschläge machen.

\noindent Wir haben bereits Pull Requests erstellt, um erste Hilfslemmata zur Mathlib hinzuzufügen bzw. um deren Beweis zu verschönern. Eine davon enthält das \lean/adjugate_fin_three/ Lemma, das besagt, dass man die Abbildungsmatrix einer $3x3$ Matrix in einer bestimmten Form darstellen kann. Dieses Lemma haben wir in Lean aufgestellt und bewiesen. Anschließend haben wir auf Anfrage im Zulip Chat der Lean Community Schreibzugriff auf das Mathlib Repository erhalten. Damit haben wir dann eine Pull Request \cite{Q16} erstellt, die dann überprüft und in die Mathlib hinzugefügt wurde. Nach diesem Schema werden wir weitere Lemmata und schlussendlich den Satz von Banach-Tarski zur Mathlib hinzufügen.

\subsection{Blueprint}
Um die Formalisierung von Banach-Tarski vorzubereiten und übersichtlicher zu machen verwendet wir eine von uns leicht modifizierte Version des frei zugänglichen leanblueprint Tools \cite{Q17}. Dieses Tool wurde auch in den Projekten zur Formalisierung der Arbeiten von Peter Scholze und Terrence Tao verwendet \cite{Q18} \cite{Q19}. Ein sogenannter Blueprint wird als erstes Schritt des Projektes erstellt und enthält eine Version des zu formaliserenden Beweises, die in kleinere Teile aufgeteilt ist und später mit dem entsprechenden Lean-Code verknüpft wird. Außerdem wird ein Dependency Graph generiert, der die Verknüpfungen zwischen den vorher in Latex verfassten Definitionen und Lemmata, die für den Beweis benötigt werden, darstellt. Zusätzlich dazu wird aus dem selben Latex Code eine print-Version generiert \cite{Q20}. Da das leanblueprint Tool ein relativ kleines Projekt ist und von wenigen Entwicklern gepflegt wird, enthielt ein neuer Commit leider einige Fehler die in unserem Fall zu einem unlesbaren und falschen dependency Graph geführt haben. Deshalb haben wir eine eigene Version des leanblueprint Tools erstellt, in der diese Fehler behoben sind \cite{Q21}. Unser Ziel ist es, diese Bugfixes möglichst bald über eine Pull Request in das offizielle Repository einzubringen.

%& TODO (Quellen oder Beispiel angeben: PFR und Liquid Tensor experiment (https://leanprover-community.github.io/liquid/index.html)) 

% \subsection{Versionsverwaltung}
% TODO evtl weglassen -> nach dem Motto "wir sind so gut, da ist das selbstverständlich"
...
\section{Der \glqq kleine Gauß\grqq; Verifikation des Beweises mit Lean}
Bevor wir uns an die Formalisierung des Banach-Tarski-Paradoxons machen, fangen wir mit einem kleineren Beispiel an; zunächst mal, um die Arbeitsweisen von Lean zu verstehen. Dieses von uns selbst \glqq geleante\grqq~Beispiel wollen wir dem Leser im folgenden Abschnitt vorstellen, um die Funktionsweise von Lean zu veranschaulichen. 
%damit man sich selber ein Bild machen kann.  

\noindent Um den folgenden Code besser nachzuvollziehen kann mit diesem Link eine Lean 4 Web Umgebung geöffnet werden: \href{https://live.lean-lang.org/#code=import%20Mathlib.Data.Nat.Basic%0D%0Aimport%20Mathlib.Data.Real.Basic%0D%0A%0D%0Adef%20CC_sum_up_to%20(n%20%3A%20Nat)%3A%20%E2%84%95%20%3A%3D%0D%0A%20%20match%20n%20with%0D%0A%20%20%20%20%7C%200%20%3D%3E%200%0D%0A%20%20%20%20%7C%20(Nat.succ%20n)%20%3D%3E%20CC_sum_up_to%20n%20%2B%20Nat.succ%20n%0D%0A%0D%0A%23eval%20CC_sum_up_to%204%0D%0A%0D%0A%0D%0A%0D%0Atheorem%20CC_kleiner_gauss%20(n%3A%20Nat)%20%3A%0D%0A%20%20CC_sum_up_to%20n%20*%202%20%3D%20n%20*%20(n%20%2B%201)%20%3A%3D%20by%0D%0A%0D%0A%20%20induction%20n%20with%0D%0A%20%20%20%20%7C%20zero%20%3D%3E%0D%0A%20%20%20%20simp%0D%0A%20%20%20%20rw%20%5BCC_sum_up_to%5D%0D%0A%20%20%20%20%7C%20succ%20d%20hd%20%3D%3E%0D%0A%20%20%20%20rw%20%5BCC_sum_up_to%5D%0D%0A%20%20%20%20rw%20%5BNat.succ_eq_add_one%5D%0D%0A%20%20%20%20rw%20%5BNat.add_mul%5D%0D%0A%20%20%20%20rw%20%5BNat.mul_add%5D%0D%0A%20%20%20%20rw%20%5BNat.mul_one%5D%0D%0A%0D%0A%20%20%20%20rw%20%5BNat.add_mul%20d%201%20(d%20%2B%201)%5D%0D%0A%20%20%20%20simp%0D%0A%20%20%20%20rw%20%5Badd_assoc%5D%0D%0A%20%20%20%20rw%20%5B%E2%86%90%20Nat.mul_two%20(d%20%2B%201)%5D%0D%0A%20%20%20%20simp%0D%0A%20%20%20%20exact%20hd}{live-lean.kleiner_gauß}\par
\vspace{0.2cm} 
...
\noindent Um zu kontrollieren, dass unsere Definition das Gewünschte liefert, können wir Lean für \lean/n/ eine bestimmte Zahl einsetzen lassen bspw. $5$. Mit dem \lean/#eval/ Befehl ist es möglich, sich die Ausgabe einer Funktion anzeigen zu lassen, in diesem Fall $15$.
%Dann erhalten wir in unserer Kontrolleiste rechts folgende Statusmeldung:
%\begin{figure}[H]
%    \centering
...
\noindent Anschließend gehen wir zum Induktionsschritt über, in dem wir voraussetzen, dass die Gleichheit für eine natürliche Zahl $d$ gilt. Diese Voraussetzung betiteln wir hier mit \lean/hd/. Dann zeigen wir, dass die Behauptung auch für $d+1$ wahr ist. Hierfür schreiben wir unser Ziel zunächst mit unserer eigenen Definition \lean/CC_sum_up_to/ um. Anschließend verwenden wir unter der Taktik \lean/rw/ eine Reihe an in der Mathlib Bibliothek verfügbaren bereits bewiesen Axiome. Die Namen dieser Axiome verraten schon, wie diese das Ziel umformen werden. Die \lean/simp/ Befehle vereinfachen das theroem weiter und die \lean/exact hd/ Taktik wendet die Aussage \lean/hd/ an und schließt damit den Beweis ab.
...
% TODO zu mehr ressourcen über lean verlinken
%-------------------------------------------------------------------------------------------------------------------
%-------------------------------------------------------------------------------------------------------------------
%-------------------------------------------------------------------------------------------------------------------
%-------------------------------------------------------------------------------------------------------------------
...
\noindent Auch hier besteht die Möglichkeit, zum besseren Verständnis des Beweises durch folgenden Link auf die Livelean Version des Programms zuzugreifen:
...
Nachdem wir uns und den Leser durch ein kleines Beispiel mit den Prinzipien von Lean vertraut gemacht haben, wollen wir nun einen komplexeren Satz als Erste überhaupt in Lean formalisieren und diesen dann in einem späteren Schritt in die Mathlib Bibliothek aufnehmen lassen.
...
\noindent Dass der formale Beweis etwas mehr ins Detail geht ist klar, jedoch führen wir diesen aus Platzgründen nicht vollständig auf. Wer sich für den vollständigen Beweis des Banach-Tarski-Paradoxons im dreidimensionalen Raum interessiert, der kann hier (\cite{Q22}) eine Version einsehen. Damit der Leser aber das folgende Kapitel versteht, wollen wir auf die durch zwei unabhängige Winkel erzeugte Gruppe, mit der wir arbeiten näher eingehen. Das ein solches Winkelpaar existiert, zeigen wir konstruktiv. Hierfür wählen wir uns den Winkel $arccos(\frac{1}{3})$. Wir definieren uns nun $A$ als die Drehmatrix zum Drehwinkel $arccos(\frac{1}{3})$ um die x-Achse und $B$ als die Drehmatrix zum selben Winkel um die z-Achse.\par
...
\noindent Bevor wir die Behauptung für den ersten Fall beweisen, müssen wir die Behauptung im Voraus einzeln für unsere beiden erzeugenden Matrizen \lean/CC_gl_a/ und \lean/CC_gl_b/ zeigen. Für \lean/CC_gl_a/ erreichen wir das durch folgendes Theorem:\par
%\vspace{-0.15cm}
%\hspace{-0.6cm}
%\begin{minipage}{11cm}
\begin{leancode}
...
\end{leancode}
\noindent Damit Lean die ganzen Zahlen $a,b,c,d,e,f,g,h$ und $i$ mit $\frac{1}{3^n}$ multiplizieren kann, müssen wir ihm zunächst vorgeben, dass $a,b,c,d,e,f,g,h$ und $i$ ebenfalls vom Typ der reellen Zahlen sind. An einem vollständigen Beweis, dass diese allgemeine Form für alle Elemente in $G$ gilt, arbeiten wir noch.
...
theorem CC_h_mul (x : GL (Fin 3) Real) (hx: x ∈ G) (y: GL (Fin 3) Real) (hy: y ∈ G) 
    ...
    ...
\end{leancode}
\iffalse % unnötiger code wird auskommentiert
  rw [CC_rotate]
...
%\end{leancode}
\noindent Damit ist mit folgendem Theorem der Satz \ref{lemma1} bewiesen:
\begin{leancode}
theorem CC_satz_3_1 (p: GL (Fin 3) Real) (h: p ∈ G):
       ∃ a b c : ℤ, ∃ n : ℕ, CC_rotate p CC_zero_one_zero = CC_a_b_c_vec a b c n:=
  Subgroup.closure_induction' CC_h_s CC_h_one CC_h_mul CC_h_inv h
\end{leancode}
\subsubsection{Definition der Äquidekomponierbarkeit in Lean}
\noindent Außer dem Satz aus dem letzten Kapitel ist es uns außerdem gelungen, die Äquidekomponierbarkeit von zwei beliebigen Mengen $X$ und $Y$ in Lean zu definieren. D. h., dass wir $X$ in eine endliche Anzahl an disjunkten Teilmengen zerlegen können, diese dann jeweils durch Rotationen so verändern können, sodass die Vereinigung der gedrehten Teilmengen die Menge $Y$ ergibt. Bevor uns dies aber gelungen ist, mussten wir vorab aber noch einige Dinge der Übersicht halber definieren. Als erstes definieren wir uns den Schnitt von zwei Mengen $A$ und $B$ als Funktion, was spätere Schritte einfacher macht:
\begin{leancode}
def intersection (α : Type) (a b : Set α) : Set α := a ∩ b
\end{leancode}
\noindent Anschließend benutzen wir diese Funktion, um den Schnitt von mehreren Mengen zu definieren. Die Mengen, von denen der Schnitt gebildet werden soll, ordnen wir in Lean zuerst in einer Liste $x$ an. Dann falten wir die Liste $x$ von links her mit der oben definierten Funktion \lean/intersection/ zusammen.
\begin{leancode}
...
\noindent Zudem definieren wir uns, was wir unter der Rotation einer Menge von Punkten verstehen.
\begin{leancode}
...
%\noindent Um diese Definition übersichtlicher und einfacher lesbar zu machen, haben wir die \lean/remove_first/ Funktion definiert, die das erste Element aus einer Liste entfernt und den Rest zurück gibt.
%\begin{leancode}
...
\end{leancode}
\section{Ergebnisse}
Als erstes haben wir uns mit dem mathematischen Beweis des Banach-Tarski Paradoxons befasst und diesen für eine Formalisierung in Lean angepasst. Um diese modifizierte Version des Beweises zu Veranschaulichen haben einen Blueprint erstellt und auf unserer \href{https://bergschaf.github.io/banach-tarski/}{Internetseite} veröffentlicht . Um diesen Blueprint besser zu visualisieren mussten wir einige Modifikationen an dem Leanblueprint Tool vornehmen. Anhand von diesem Blueprint haben wir bereits einen Teil des Banach-Tarski Paradoxons in Lean formalisiert. Eines dieser formalsierten Hilfslemmata befindet sich bereits im Aufnahmeprozess in die Mathlib. Außerdem haben wir bereits eine kleine verbesserung an einem bereits in der Mathlib vorhandenen Lemma vorgenommen. Diese Änderungen haben wir auch schon mit einer Pull Request in die Mathlib hinzugefügt. Außerdem haben wir eine verbesserte Version des Lean 4 Webeditors entwickelt, die es einfacher macht, an großen Projekten zu arbeiten.

\section{Ausblick}
Mit Satz \ref{lemma1} ist der Beweis des Banach-Tarski Paradoxons selbstverständlich noch nicht abgeschlossen. Aber wir sind auf einem guten Weg und werden es schaffen. Unser Ziel ist es, im Rahmen dieses Projekts, die hierfür noch notwendigen Sätze und Lemmas zu leanen und so schlussendlich das Banach-Tarksi-Paradoxon in Gänze zu verifizieren. Den fertigen Beweis werden wir dann zur Mathlib beisteuern und diese so einen Schritt weiterbringen. % und so ein kleines Mosaiksteinchen in der Lean-Community sein. 

\noindent Auch rein mathematisch, zunächst unabhängig von Lean, arbeiten wir daran, Banach-Tarski zu erweitern. Wir haben uns zum Ziel gesetzt, diesen Satz für beliebig viele Dimensionen zu verallgemeinern und zu beweisen. Natürlich werden wir auch diese eigenen Beweise am Ende mit Lean verifizieren.
...
\bibitem{Q2}
\url{https://www.zeit.de/2024/09/computer-mathematik-beweise-ueberpruefung-vertrauen}
\bibitem{Q3}
...
\bibitem{Q5}
\url{https://www.youtube.com/watch?v=AayZuuDDKP0&t=261s}
\bibitem{Q6}
...
\bibitem{Q13}
\url{https://github.com/Bergschaf/lean4web-banach-tarski}
\bibitem{Q14}
\url{https://leanprover-community.github.io/undergrad.html}
\bibitem{Q15}
\url{https://github.com/leanprover-community/mathlib4}
\bibitem{Q16}
\url{https://github.com/leanprover-community/mathlib4/pull/11005}
\bibitem{Q17}
...
\bibitem{Q20}
\url{https://bergschaf.github.io/banach-tarski/}
\bibitem{Q21}
\url{https://github.com/Bergschaf/leanblueprint}
\bibitem{Q22}
